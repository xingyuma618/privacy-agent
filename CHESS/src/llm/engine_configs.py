...
ENGINE_CONFIGS: Dict[str, Dict[str, Any]] = {
    ...
    #                 "openai_api_key": "sk-533b918073e141ee9857ebf7d78598ec"
    #                }
    # },
    # "deepseek-chat": {
    #     "constructor": ChatOpenAI,
    ...
    #                 "openai_api_key": "sk-uV9gEkGNWHW0B1enA900F98e9e4642CfBcD6F1A8Dd56FeE6"
    #                }
    # },
    ...
    #     "params": {
    #                "temperature": 0,
    #                "model": "/home/share/models/Qwen3-235B-A22B/",
    #                "openai_api_base": "http://172.16.10.7:2333/v1",
    #                 "openai_api_key": "EMPTY"
    #                }
    # },
    #  "deepseek-chat": {
    ...
    #     "params": {
    #                "temperature": 0,
    #                "model": "/home/share/models/DeepSeek-V2.5",
    #                "openai_api_base": "http://172.16.10.8:2333/v1",
    #                 "openai_api_key": "EMPTY"
    #                }
    # },
    # "deepseek-chat": {
    ...
    #     "params": {
    #                "temperature": 0,
    #                "model": "/mnt/lustre/maxingyu/models/DeepSeek-Coder-V2-Instruct/",
    #                "openai_api_base": "http://172.16.10.6:2333/v1",
    #                 "openai_api_key": "EMPTY"
    #                }
    # },
    "deepseek-chat": {
        ...
        "params": {
                   "temperature": 0,
                   "model": "/root/models/Qwen2.5-72B-Instruct",
                   "openai_api_base": "http://127.0.0.1:2333/v1",
                    "openai_api_key": "EMPTY"
                   }
    }
    # "deepseek-chat": {
    ...
    #     "params": {
    #                "temperature": 0,
    #                "model": "/mnt/lustre/maxingyu/models/Qwen2.5-Coder-14B-Instruct/",
    #                "openai_api_base": "http://172.16.10.6:2333/v1",
    #                 "openai_api_key": "EMPTY"
    #                }
    # }
